 ...
 * 
 * @see com.haochi.platform.persistence.dao.userinfo.Userinfo
...
public class UserinfoDAO extends BaseHibernateDAO {
	...
	public static final String USERGENDA = "usergenda";
	public static final String USERMAILBOX = "usermailbox";
	...
	public List findByUsergenda(Object usergenda) {
		return findByProperty(USERGENDA, usergenda);
	}
	
	public List findByUsermailbox(Object usermailbox) {
		return findByProperty(USERMAILBOX, usermailbox);
	}
